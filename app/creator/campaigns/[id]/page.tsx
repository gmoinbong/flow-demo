...
export default function CreatorCampaignDetailPage() {
  ...
  const [campaign, setCampaign] = useState(getCampaignById(campaignId));
  ...
  const handleContentSubmit = () => {
    ...
    setTimeout(() => {
      // Update allocation with content submission
      ...
      saveAllocation(updatedAllocation);
              ...
              <CardContent>
                <div className='space-y-4'>
                  <div>
                    ...
                    <Progress
                      value={(allocation.performance.reach / 15000) * 100}
                    />
                  </div>
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                    ...
                    <Progress
                      value={(allocation.performance.engagement / 3.5) * 100}
                    />
                  </div>
                  <div>
                    <div className='flex items-center justify-between mb-2'>
                    ...
                    <Progress
                      value={(allocation.performance.conversions / 100) * 100}
                    />
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value='content' className='space-y-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload your content for brand approval
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  ...
                  />
                  <p className='text-xs text-muted-foreground'>
                    Paste the link to your Instagram post, TikTok video, or
                    YouTube video
                  </p>
                </div>
                  ...
                  <div className='flex items-start gap-2'>
                    ...
                    <div>
                      ...
                      <ul className='text-xs text-blue-700 mt-2 space-y-1 list-disc list-inside'>
                        <li>
                          Add this link to your bio or content description
                        </li>
                        <li>
                          All clicks and conversions will be tracked
                          automatically
                        </li>
          ...
          <TabsContent value='contract' className='space-y-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Review your agreement with the brand
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
